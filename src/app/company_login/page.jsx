...
const CompanyLogin = () => {
  ...
  async function handleLoginClick() {
    const result = await fetch(
      `http://localhost:3000/api/company?email=${email}&password=${password}`,
      {
        method: "GET",
        headers: {
        ...
        <div className=" rounded-2xl bg-accent2 shadow-2xl flex flex-row w-2/3 max-w-4xl ">
          <div className="w-3/5 p-5">
            ...
            <form action="#" className="flex py-13 flex-col items-center">
              ...
              />
              <a href="#" className="text-accent1 text-sm mb-4">
          ...
          <div className="w-2/5 rounded-tr-2xl rounded-br-2xl bg-accent1 text-bg py-36 px-12">
            ...
            <p className="text-lg text-bg">
              Want to add your company alongside with your game to take part in
              the voting?{" "}
            </p>
            <button
